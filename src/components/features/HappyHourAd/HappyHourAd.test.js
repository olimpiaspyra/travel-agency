...
const mockProps = {
  ...
  promoDescription: 'Example of description',
};
...
describe('Component HappyHourAd with mocked Date at promo time after delay', () => {
  checkDescriptionAfterTime('11:59:58', 2, mockProps.promoDescription);
  checkDescriptionAfterTime('11:59:59', 32, mockProps.promoDescription);
});
